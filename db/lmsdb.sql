...
-- Dumping database structure for learning_ms
DROP DATABASE IF EXISTS `learning_ms`;
CREATE DATABASE IF NOT EXISTS `learning_ms` /*!40100 DEFAULT CHARACTER SET latin1 */;
USE `learning_ms`;


-- Dumping structure for table learning_ms.activity_log
...
-- Dumping data for table learning_ms.activity_log: ~19 rows (approximately)
...
-- Dumping structure for table learning_ms.answer
...
-- Dumping data for table learning_ms.answer: ~14 rows (approximately)
DELETE FROM `answer`;
...
-- Dumping structure for table learning_ms.assignment
...
-- Dumping data for table learning_ms.assignment: ~28 rows (approximately)
...
-- Dumping structure for table learning_ms.class
...
-- Dumping data for table learning_ms.class: ~12 rows (approximately)
DELETE FROM `class`;
...
INSERT INTO `class` (`class_id`, `class_name`) VALUES
	...
	(14, 'AL ICT 2018 AL'),
	(15, 'OL ICT 2018 OL'),
	(16, 'Android Certificate B2'),
	(17, 'Android Certificate B2'),
	(18, 'Java\r\n Certificate'),
	(19, 'PHP Certificate'),
	(20, 'C# certificate'),
	(21, 'arduiono micro controller programming');
/*!40000 ALTER TABLE `class` ENABLE KEYS */;


-- Dumping structure for table learning_ms.class_quiz
...
-- Dumping data for table learning_ms.class_quiz: ~5 rows (approximately)
...
-- Dumping structure for table learning_ms.class_subject_overview
...
-- Dumping data for table learning_ms.class_subject_overview: ~3 rows (approximately)
DELETE FROM `class_subject_overview`;
...
-- Dumping structure for table learning_ms.content
...
-- Dumping data for table learning_ms.content: ~13 rows (approximately)
DELETE FROM `content`;
...
-- Dumping structure for table learning_ms.department
...
-- Dumping data for table learning_ms.department: ~4 rows (approximately)
DELETE FROM `department`;
/*!40000 ALTER TABLE `department` DISABLE KEYS */;
INSERT INTO `department` (`department_id`, `department_name`, `dean`) VALUES
	(4, 'Science & Technology', 'Dr Ruwan'),
	(5, 'School of Arts and Science', 'Chamith'),
	(9, 'College of Education', 'Chathuka'),
	(10, 'Information technology', 'Wickramarathna');
/*!40000 ALTER TABLE `department` ENABLE KEYS */;


-- Dumping structure for table learning_ms.event
...
-- Dumping data for table learning_ms.event: ~7 rows (approximately)
DELETE FROM `event`;
...
-- Dumping structure for table learning_ms.files
...
-- Dumping data for table learning_ms.files: 23 rows
DELETE FROM `files`;
...
INSERT INTO `files` (`file_id`, `floc`, `fdatein`, `fdesc`, `teacher_id`, `class_id`, `fname`, `uploaded_by`) VALUES
	...
	(138, 'admin/uploads/4031_File_itmaxinst.sql', '2015-01-21 21:34:45', 'this is itmax database', 0, 186, 'itmax', 'Chamith Chathuka'),
	(140, 'admin/uploads/3747_File_11025955_2145359678906691_3389438944531893570_n.jpg', '2015-05-25 21:02:54', 'qwe', 21, 190, 'qwe', 'Chamith Chathuka'),
	(141, 'admin/uploads/2419_File_lms.sql', '2015-11-27 18:35:18', 'z', 0, 189, 'car', 'Chamith Chathuka'),
	(142, 'admin/uploads/6270_File_appriceation of literature.pdf', '2015-12-03 06:49:21', 'AD Doc', 22, 192, 'AD', 'Chamith Chathuka'),
	(143, 'admin/uploads/9132_File_[Project Name] - Test Plan & Procedures.docx', '2015-12-05 22:21:42', 'Test Plan', 0, 192, 'Test', 'Chamith Chathuka');
/*!40000 ALTER TABLE `files` ENABLE KEYS */;


-- Dumping structure for table learning_ms.message
...
-- Dumping data for table learning_ms.message: ~0 rows (approximately)
DELETE FROM `message`;
/*!40000 ALTER TABLE `message` DISABLE KEYS */;
/*!40000 ALTER TABLE `message` ENABLE KEYS */;


-- Dumping structure for table learning_ms.message_sent
...
-- Dumping data for table learning_ms.message_sent: ~0 rows (approximately)
DELETE FROM `message_sent`;
/*!40000 ALTER TABLE `message_sent` DISABLE KEYS */;
/*!40000 ALTER TABLE `message_sent` ENABLE KEYS */;


-- Dumping structure for table learning_ms.notification
...
-- Dumping data for table learning_ms.notification: ~27 rows (approximately)
...
-- Dumping structure for table learning_ms.notification_read
...
-- Dumping data for table learning_ms.notification_read: ~12 rows (approximately)
...
-- Dumping structure for table learning_ms.notification_read_teacher
...
-- Dumping data for table learning_ms.notification_read_teacher: ~12 rows (approximately)
DELETE FROM `notification_read_teacher`;
...
-- Dumping structure for table learning_ms.question_type
...
-- Dumping data for table learning_ms.question_type: 2 rows
...
-- Dumping structure for table learning_ms.quiz
...
-- Dumping data for table learning_ms.quiz: ~5 rows (approximately)
DELETE FROM `quiz`;
...
-- Dumping structure for table learning_ms.quiz_question
...
-- Dumping data for table learning_ms.quiz_question: ~6 rows (approximately)
...
-- Dumping structure for table learning_ms.school_year
...
-- Dumping data for table learning_ms.school_year: ~4 rows (approximately)
...
-- Dumping structure for table learning_ms.student
...
-- Dumping data for table learning_ms.student: 46 rows
DELETE FROM `student`;
...
-- Dumping structure for table learning_ms.student_assignment
...
-- Dumping data for table learning_ms.student_assignment: ~17 rows (approximately)
...
-- Dumping structure for table learning_ms.student_backpack
...
-- Dumping data for table learning_ms.student_backpack: ~0 rows (approximately)
...
-- Dumping structure for table learning_ms.student_class_quiz
...
-- Dumping data for table learning_ms.student_class_quiz: ~5 rows (approximately)
DELETE FROM `student_class_quiz`;
...
-- Dumping structure for table learning_ms.subject
...
-- Dumping data for table learning_ms.subject: 18 rows
DELETE FROM `subject`;
...
-- Dumping structure for table learning_ms.teacher
...
-- Dumping data for table learning_ms.teacher: 9 rows
DELETE FROM `teacher`;
...
-- Dumping structure for table learning_ms.teacher_backpack
...
-- Dumping data for table learning_ms.teacher_backpack: ~0 rows (approximately)
DELETE FROM `teacher_backpack`;
/*!40000 ALTER TABLE `teacher_backpack` DISABLE KEYS */;
/*!40000 ALTER TABLE `teacher_backpack` ENABLE KEYS */;


-- Dumping structure for table learning_ms.teacher_class
...
-- Dumping data for table learning_ms.teacher_class: ~35 rows (approximately)
...
-- Dumping structure for table learning_ms.teacher_class_announcements
...
-- Dumping data for table learning_ms.teacher_class_announcements: ~16 rows (approximately)
DELETE FROM `teacher_class_announcements`;
...
-- Dumping structure for table learning_ms.teacher_class_student
...
-- Dumping data for table learning_ms.teacher_class_student: ~337 rows (approximately)
DELETE FROM `teacher_class_student`;
...
-- Dumping structure for table learning_ms.teacher_notification
...
-- Dumping data for table learning_ms.teacher_notification: ~8 rows (approximately)
DELETE FROM `teacher_notification`;
...
-- Dumping structure for table learning_ms.teacher_shared
...
-- Dumping data for table learning_ms.teacher_shared: ~1 rows (approximately)
DELETE FROM `teacher_shared`;
...
-- Dumping structure for table learning_ms.users
...
-- Dumping data for table learning_ms.users: ~2 rows (approximately)
DELETE FROM `users`;
/*!40000 ALTER TABLE `users` DISABLE KEYS */;
INSERT INTO `users` (`user_id`, `username`, `password`, `firstname`, `lastname`) VALUES
	(15, 'admin', 'admin', 'admin', 'admin'),
	(16, 'chamith', '123', 'Chamith', 'Chathuka');
/*!40000 ALTER TABLE `users` ENABLE KEYS */;


-- Dumping structure for table learning_ms.user_log
...
-- Dumping data for table learning_ms.user_log: ~136 rows (approximately)
